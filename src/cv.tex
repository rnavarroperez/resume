...
\section{<Teaching experience (including course redesign)|Experiencia docente>}
...
\section{<Teaching training|Capacitación docente>}

\entry{
  date = {2021},
  title = {The Motivating Learners Course},
  institution = {Motivate Lab},
  description = {Emphasizing growth mindset, purpose, and sense of belonging in students}
}

\entry{
  date = {2019},
  title = {Supporting Undocumented and Mixed-Immigration Status Students},
  institution = {Center for Teaching and Learning},
}

\entry{
  date = {2019},
  title = {Supporting Students Facing Economic Challenges},
  institution = {Center for Teaching and Learning},
}

\entry{
  date = {2018},
  title = {Designing Lectures for Increased Student Engagement},
  institution = {Center for Teaching and Learning},
}
...
%  date = {since 2021},
%  name = {Ky Putnam},
%  project = {Uncertaintiy Quantification in local Chiral interactions},
%  host = {San Diego State University}
% }

% \student{
%  date = {since 2021},
%  name = {Nathaniel Saavedra},
%  project = {Statistical Analysis of Stable Nuclei Collision},
%  host = {San Diego State University}
% }
...
% \entry{
%   date = {<Sept|Septiembre> 2019},
%   title = {Human Side of Science Distinguished Speaker Series at University of San Diego},
%   address = {San Diego, CA <USA|EEUU>},
%   description = {
%     \f{<Title|Título>} ``Uncertainty Quantification in the supercomputing era'' }
% }


% \entry{
%   date = {<Nov|Noviembre> 2019},
...
% \subsection{<Diversity, equity and inclusion efforts|Esfuerzos para la diversidad, equidad e inclusión>}
 % \committee{
 %   date = {since 2021},
 %   venue = {<Member of the Cal-Bridge Partnership committee|Miembro del comité de Asociación del programa Cal-Bridge> }
 % }
...
\committee{
   date = {Fall 2019},
   venue = {<Undergraduate Physics brochure redesign|Nuevo folleto para la licenciatura en física> }
 }
...
%   \entry{
%     date = {2018},
%     title = {<Facilitator|Facilitador>},
%     organisation = {<Science Olympiad|Olimpiada de la Ciencia>},
%     address = {Ohio University, <USA|EEUU> }    
%   }
...
\reference{
  ...
  institution = {<Physics Department|
                  Departamento de Física>. San Diego State University},
  address = {550 Campanile Drive, San Diego CA-92182, <USA|EEUU>},
  phone = {+1~(619)~594~6240},
  email = {usinha@sdsu.edu},
}

\reference{
  name = {Alexander Rudolph},
  institution = {<Department of Physics and Astronomy|
                  Departamento de Física y Astronomía>. California State Polytechnic University},
  address = {3801 West Temple Blvd, Pomona CA-91768, <USA|EEUU>},
  phone = {+1~(909)~717~1851},
...
\reference{
  ...
  address = {Clippinger 267, Athens OH-45701, <USA|EEUU>},
  phone = {+1~(740)~593~0336},
